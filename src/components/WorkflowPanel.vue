<template>
  ...
  <n-drawer v-model:show="visible" :width="360" placement="left">
    <n-drawer-content title="工作流模板" closable>
      <!-- Tabs | 标签页 -->
      <n-tabs type="line" animated>
        <n-tab-pane name="public" tab="公共工作流">
        ...
        <n-tab-pane name="my" tab="我的工作流">
          <div class="empty-state">
            <n-icon :size="48" class="text-gray-400">
              <FolderOpenOutline />
            </n-icon>
            <p class="text-gray-500 mt-2">暂无自定义工作流</p>
            <p class="text-gray-400 text-xs mt-1">功能开发中...</p>
          </div>
        </n-tab-pane>
      </n-tabs>
